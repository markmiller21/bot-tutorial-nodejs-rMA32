...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/rg/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/rg/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/rg/players?name="+rep+"&position=all&team=all");
